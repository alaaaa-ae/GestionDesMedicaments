...
namespace GestionDesMedicaments
{
    public class GestionClientsForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // ListView Clients
            this.listViewClients.Location = new Point(20, 120);
            this.listViewClients.Size = new Size(600, 300);
            this.listViewClients.View = View.Details;
            this.listViewClients.FullRowSelect = true;
            this.listViewClients.GridLines = true;
            this.listViewClients.BorderStyle = BorderStyle.None;
            ...
            // ListView Factures
            this.listViewFactures.Location = new Point(640, 120);
            this.listViewFactures.Size = new Size(580, 300);
            this.listViewFactures.View = View.Details;
            this.listViewFactures.FullRowSelect = true;
            this.listViewFactures.GridLines = true;
            this.listViewFactures.BorderStyle = BorderStyle.None;
        ...
        private void AjusterTailles()
        {
            ...
            if (contentWidth > 0)
            {
                ...
                this.listViewClients.Size = new Size(listWidth, 300);
                this.listViewFactures.Location = new Point(listWidth + 40, 120);
                this.listViewFactures.Size = new Size(listWidth, 300);
                
                var panelFormulaire = this.panelContent.Controls.OfType<Panel>().FirstOrDefault(p => p.Controls.Contains(txtNomUtilisateur));
                if (panelFormulaire != null) panelFormulaire.Size = new Size(listWidth, 350);
                ...
                {
                    panelPaiement.Location = new Point(listWidth + 40, 440);
                    panelPaiement.Size = new Size(listWidth, 350);
                }
            }
        }
